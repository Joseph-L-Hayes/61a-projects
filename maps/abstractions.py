...
def make_review(restaurant_name, rating):
    ...
    return [restaurant_name, rating] #returns a review
...
def restaurant_ratings(restaurant):
    ...
    rating_list = []
    i = 0
    while i <= len(restaurant[4])-1:
        rating_list += [review_rating(restaurant[4][i])]
        i+= 1 #needed to use review_rating to get the review number abrstraction barrier!
